...
public:
    ...
    void Build( QFont &font, bool blur = false );
    void Delete();

    void GetTextExtent( const QString &string, int *width, int *height);
    void RenderString( const char *string, int x=0, int y=0 );
    void RenderString( const QString &string, int x=0, int y=0 );
