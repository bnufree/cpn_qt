...
TCDataSource::~TCDataSource()
{
    ZCHX_LOGMSG(wxString::Format(_T("UnLoading Tide/Current data source: %s"), m_data_source_path.c_str()));
...
TC_Error_Code TCDataSource::LoadData(const wxString &data_file_path)
{
    ...
    ZCHX_LOGMSG(wxString::Format(_T("Loading Tide/Current data source: %s"), m_data_source_path.c_str()));
