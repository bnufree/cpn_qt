...
class cm93_dictionary
{
      public:
            ...
            bool LoadDictionary(const QString & dictionary_dir);
            bool IsOk(void){ return m_ok; }
            QString GetDictDir(void){ return m_dict_dir; }

            QString GetClassName(int iclass);
            QString GetAttrName(int iattr);
...
public:
    cm93manager();
    ~cm93manager();
    bool Loadcm93Dictionary(const QString & name);
    cm93_dictionary *FindAndLoadDict(const QString &file);
...
class cm93chart : public s57chart
{
      public:
            ...
            InitReturn Init( const QString& name, ChartInitFlag flags );
            ...
            void SetCM93Prefix(const QString &prefix){m_prefix = prefix;}
            ...
            const QString & GetLastFileName(void) const { return m_LastFileName; }
      ...
      private:
            ...
            void translate_colmar(const QString &sclass, S57attVal *pattValTmp);
