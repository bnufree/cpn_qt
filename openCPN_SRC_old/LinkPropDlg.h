...
class LinkPropDlgDef : public wxDialog
{
	...
	public:
		...
		LinkPropDlgDef( wxWindow* parent, wxWindowID id = wxID_ANY, const QString& title = _("Link Properties"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 468,247 ), long style = wxDEFAULT_DIALOG_STYLE );
		~LinkPropDlgDef();
...
{
public :
      LinkPropImpl( wxWindow* parent, wxWindowID id = wxID_ANY, const QString& title = _("Link Properties"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 468,247 ), long style = wxDEFAULT_DIALOG_STYLE );
private :
