...
public:
    ...
    int GetStationIDXbyName(const QString & prefix, double xlat, double xlon) const;
    int GetStationIDXbyNameType(const QString & prefix, double xlat, double xlon, char type) const;
