...
public:
    ...
    void drawMapPlain( ocpnDC &pnt, double dx, ViewPort &vp, QColor seaColor,
...
private:
    ...
    void DrawPolygonFilled( ocpnDC &pnt, contour_list * poly, double dx, ViewPort &vp,
            QColor const &color );
#ifdef ocpnUSE_GL        
    void DrawPolygonFilledGL( contour_list * p, float_2Dpt **pv, int *pvc, ViewPort &vp,  QColor const &color, bool idl );
#endif
...
public:
    ...
    void drawGshhsPolyMapPlain( ocpnDC &pnt, ViewPort &vp, QColor const &seaColor,
...
public:
    ...
    void drawContinents( ocpnDC &pnt, ViewPort &vp, QColor const &seaColor, QColor const &landColor );
    ...
    static QString getNameExtension( int quality );
    static QString getFileName_boundaries( int quality );
    static QString getFileName_rivers( int quality );
    static QString getFileName_Land( int quality );
