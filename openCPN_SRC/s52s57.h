...
typedef struct _Rule{
   ...
   union          {QString   *LXPO,      *PXPO,      *SXPO;      } exposition;
   union          {QString   *dummy,     *PBTM,      *SBTM;      } bitmap;
...
public:
    ...
    QString   frmtd;       // formated text string
    char       hjust;
    char       vjust;
    char       space;
    char       style;       // CHARS
    ...
    QRect      rText;          // rectangle of the text as currently rendered, used for declutter
...
typedef QList<S57attVal*> wxArrayOfS57attVal ;
...
public:
      ...
      QString GetAttrValueAsString ( const char *attr );
...
typedef QList<Rules*> ArrayOfRules;
...
typedef QHash<int, VE_Element*> VE_Hash;
typedef QHash<int, VC_Element*> VC_Hash;
...
//    unsigned long hash() const;
    bool operator == (const connector_key &e2)
    {
...
typedef QHash<connector_key, connector_segment *> connected_segment_hash;
