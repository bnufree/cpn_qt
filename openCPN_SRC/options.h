...
class options : private Uncopyable,
 ...
 public:
  ...
  size_t CreatePanel(const QString &title);
  wxScrolledWindow *AddPage(size_t parent, const QString &title);
  bool DeletePluginPage(wxScrolledWindow *page);
  void SetColorScheme(ColorScheme cs);
  void RecalculateSize(void);

  void SetInitChartDir(const QString &dir) { m_init_chart_dir = dir; }
  ...
  void AddChartDir(const QString &dir);
...
class ChartGroupsUI : private Uncopyable, public wxScrolledWindow {
 public:
  ...
  wxTreeCtrl *AddEmptyGroupPage(const QString &label);
...
class SentenceListDlg : private Uncopyable, public wxDialog {
 ...
 private:
  ...
  QString GetBoxLabel(void) const;
...
class OpenGLOptionsDlg : private Uncopyable, public wxDialog {
 ...
 private:
  ...
  QString GetTextureCacheSize(void);
...
public:
    ...
    QString GetCreatedTemplateGUID(){ return m_createdTemplateGUID; }
