...
protected:
    ...
    RoutePropDlgImpl( wxWindow* parent, wxWindowID id = wxID_ANY, const QString& title = _("Route Properties"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 550,450 ), long style = wxDEFAULT_FRAME_STYLE|wxFRAME_FLOAT_ON_PARENT|wxMAXIMIZE_BOX|wxRESIZE_BORDER );
...
private:
    ...
    QString MakeTideInfo( QString stationName, double lat, double lon, wxDateTime utcTime );
};
