...
public:
    ConnectionParams();
    ~ConnectionParams();
    ConnectionParams(const QString &configStr);
    ...
    QString        Serialize();
    void            Deserialize(const QString &configStr);

    QString GetSourceTypeStr();
    QString GetAddressStr();
    QString GetParametersStr();
    QString GetIOTypeValueStr();
    QString GetFiltersStr();
    QString GetDSPort();
    QString GetLastDSPort();
    QString GetPortStr(){ return Port; }
    void SetPortStr( QString str ){ Port = str; }
...
private:
    QString FilterTypeToStr(ListType type, FilterDirection dir);
