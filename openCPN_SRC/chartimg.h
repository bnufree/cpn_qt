...
//    Methods
      ...
      InitReturn Init( const QString& name, ChartInitFlag init_flags );
...
class ChartPlugInWrapper : public ChartBaseBSB
{
      public:
            ChartPlugInWrapper();
            ChartPlugInWrapper(const QString &chart_class);
...
//    Accessors
            ...
            virtual bool RenderRegionViewOnGLTextOnly(QGLContext *glc, const ViewPort& VPoint,
