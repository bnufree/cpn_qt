...
class DECL_EXP PlugInChartBase : public QObject
{
      public:
            ...
            virtual QString GetFileSearchMask(void);

            virtual int Init( const QString& full_path, int init_flags );
            ...
            virtual QBitmap &RenderRegionView(const PlugIn_ViewPort& VPoint, const QRegion &Region);

            virtual bool AdjustVP(PlugIn_ViewPort &vp_last, PlugIn_ViewPort &vp_proposed);

            virtual void GetValidCanvasRegion(const PlugIn_ViewPort& VPoint, QRegion *pValidRegion);
            ...
            virtual QBitmap *GetThumbnail(int tnx, int tny, int cs);

//    Accessors, need not be overridden in derived class if the member variables are maintained
            virtual QString GetFullPath() const            { return m_FullPath;}
            ...
            virtual QString GetID()                        { return m_ID;}
            virtual QString GetSE()                        { return m_SE;}
            virtual QString GetDepthUnits()                { return m_DepthUnits;}
            virtual QString GetSoundingsDatum()            { return m_SoundingsDatum;}
            virtual QString GetDatumString()               { return m_datum_str;}
            virtual QString GetExtraInfo()                 { return m_ExtraInfo; }
...
//    Methods pertaining to CHART_FAMILY_RASTER type PlugIn charts only
            virtual void ComputeSourceRectangle(const PlugIn_ViewPort &vp, QRect *pSourceRect);
...
//    Declare an array of PlugIn_AISargets
typedef QList<PlugIn_AIS_Target *> ArrayOfPlugIn_AISargets;
...
public:
      ...
      virtual QBitmap *GetPlugInBitmap();
      ...
      virtual void ShowPreferencesDialog( QWindow* parent );
      ...
      virtual void SetNMEASentence(QString &sentence);
      virtual void SetAISSentence(QString &sentence);
      ...
      virtual QStringList GetDynamicChartClassNameArray(void);
 };
 ...
 class DECL_EXP opencpn_plugin_16 : public opencpn_plugin
 {
       public:
             ...
             virtual void SetPluginMessage(QString &message_id, QString &message_body);
...
class DECL_EXP opencpn_plugin_17 : public opencpn_plugin
{
       public:
             ...
             virtual bool RenderOverlay(wxDC &dc, PlugIn_ViewPort *vp);
             virtual bool RenderGLOverlay(QGLContext *pcontext, PlugIn_ViewPort *vp);
...
public:
    ...
    virtual bool MouseEventHook( QMouseEvent &event );
    virtual void SendVectorChartObjectInfo(QString &chart, QString &feature, QString &objname, double lat, double lon, double scale, int nativescale);
...
public:
    ...
    virtual bool RenderGLOverlayMultiCanvas(QGLContext *pcontext, PlugIn_ViewPort *vp, int canvasIndex);
...
typedef QList<Plugin_Hyperlink> Plugin_HyperlinkList;
...
public:
    ...
    PlugIn_Waypoint(double lat, double lon,
                    const QString& icon_ident, const QString& wp_name,
...
typedef QList<PlugIn_Waypoint> Plugin_WaypointList;
...
extern "C"  DECL_EXP int InsertPlugInTool(QString label, QBitmap *bitmap, QBitmap *bmpRollover, wxItemKind kind,
                                          QString shortHelp, QString longHelp, QObject *clientData, int position,
...
extern "C"  DECL_EXP void SetToolbarToolBitmaps(int item, QBitmap *bitmap, QBitmap *bmpRollover);

extern "C"  DECL_EXP int InsertPlugInToolSVG(QString label, QString SVGfile, QString SVGfileRollover, QString SVGfileToggled,
                                          wxItemKind kind, QString shortHelp, QString longHelp,
                                          QObject *clientData, int position, int tool_sel, opencpn_plugin *pplugin);
extern "C"  DECL_EXP void SetToolbarToolBitmapsSVG(int item, QString SVGfile,
                                                   QString SVGfileRollover,
                                                   QString SVGfileToggled );

extern "C"  DECL_EXP  int AddCanvasContextMenuItem(QAction *pitem, opencpn_plugin *pplugin );
...
extern "C"  DECL_EXP void RequestRefresh(QWindow *);
extern "C"  DECL_EXP bool GetGlobalColor(QString colorName, QColor *pcolour);

extern "C"  DECL_EXP void GetCanvasPixLL(PlugIn_ViewPort *vp, QPoint *pp, double lat, double lon);
extern "C"  DECL_EXP void GetCanvasLLPix( PlugIn_ViewPort *vp, QPoint p, double *plat, double *plon);
...
extern "C"  DECL_EXP ArrayOfPlugIn_AISargets *GetAISTargetArray(void);

extern "C"  DECL_EXP wxAuiManager *GetFrameAuiManager(void);

extern "C"  DECL_EXP bool AddLocaleCatalog( QString catalog );

extern "C"  DECL_EXP void PushNMEABuffer( QString str );

extern  DECL_EXP QDomDocument GetChartDatabaseEntryXML(int dbIndex, bool b_getGeom);

extern  DECL_EXP bool UpdateChartDBInplace(QStringList dir_array,
                          bool b_force_update,
                          bool b_ProgressDialog);
extern  DECL_EXP QStringList GetChartDBDirArrayString();

extern "C"  DECL_EXP void SendPluginMessage( QString message_id, QString message_body );

extern "C"  DECL_EXP void DimeWindow(QWindow *);
...
extern "C" DECL_EXP bool DecodeSingleVDOMessage( const QString& str, PlugIn_Position_Fix_Ex *pos, QString *acc );
...
extern DECL_EXP wxScrolledWindow *AddOptionsPage( OptionsParentPI parent, QString title );
...
extern DECL_EXP QString getUsrDistanceUnit_Plugin( int unit = -1 );
extern DECL_EXP QString getUsrSpeedUnit_Plugin( int unit = -1 );
extern DECL_EXP QString GetNewGUID();
 ...
 * on sound backend.
 */
extern DECL_EXP void PlugInPlaySound( QString &sound_file );




// API 1.10 Route and Waypoint Support
extern DECL_EXP QBitmap *FindSystemWaypointIcon( QString& icon_name );
extern DECL_EXP bool AddCustomWaypointIcon( QBitmap *pimage, QString key, QString description );

extern DECL_EXP bool AddSingleWaypoint( PlugIn_Waypoint *pwaypoint, bool b_permanent = true);
extern DECL_EXP bool DeleteSingleWaypoint( QString &GUID );
...
extern DECL_EXP bool DeletePlugInRoute( QString& GUID );
extern DECL_EXP bool UpdatePlugInRoute ( PlugIn_Route *proute );

extern DECL_EXP bool AddPlugInTrack( PlugInrack *ptrack, bool b_permanent = true );
extern DECL_EXP bool DeletePlugInTrack( QString& GUID );
extern DECL_EXP bool UpdatePlugInTrack ( PlugInrack *ptrack );

/* API 1.11  */

/* API 1.11  adds some more common functions to avoid unnecessary code duplication */
QColor DECL_EXP GetBaseGlobalColor(QString colorName);
int DECL_EXP OCPNMessageBox_PlugIn(QWindow *parent,
                          const QString& message,
                          const QString& caption = QString("Message"),
                          int style = QMessageBox::Ok, int x = -1, int y = -1);

extern DECL_EXP QString toSDMM_PlugIn(int NEflag, double a, bool hi_precision = true);

extern "C"  DECL_EXP QString *GetpPrivateApplicationDataLocation();
extern  DECL_EXP QString GetOCPN_ExePath( void );
extern "C"  DECL_EXP QString *GetpPlugInLocation();
extern  DECL_EXP QString GetPlugInPath(opencpn_plugin *pplugin);

extern "C"  DECL_EXP int AddChartToDBInPlace( QString &full_path, bool b_RefreshCanvas );
extern "C"  DECL_EXP int RemoveChartFromDBInPlace( QString &full_path );
extern  DECL_EXP QString GetLocaleCanonicalName();
...
typedef QList<PI_S57Obj> ListOfPI_S57Obj;
...
public:
    ...
    virtual int RenderRegionViewOnGL( const QGLContext &glc, const PlugIn_ViewPort& VPoint,
                                      const QRegion &Region, bool b_use_stencil );

    virtual ListOfPI_S57Obj *GetObjRuleListAtLatLon(float lat, float lon, float select_radius, PlugIn_ViewPort *VPoint);
    virtual QString CreateObjDescriptions( ListOfPI_S57Obj* obj_list );
...
public:
    ...
    virtual QBitmap &RenderRegionViewOnDCNoText(  const PlugIn_ViewPort& VPoint, const QRegion &Region);
    virtual bool RenderRegionViewOnDCTextOnly( wxMemoryDC &dc, const PlugIn_ViewPort& VPoint, const QRegion &Region);
    
    virtual int RenderRegionViewOnGLNoText( const QGLContext &glc, const PlugIn_ViewPort& VPoint,
                                            const QRegion &Region, bool b_use_stencil );

    virtual int RenderRegionViewOnGLTextOnly( const QGLContext &glc, const PlugIn_ViewPort& VPoint,
                                              const QRegion &Region, bool b_use_stencil );
...
QString DECL_EXP PI_GetPLIBColorScheme();
...
int DECL_EXP PI_PLIBRenderAreaToDC( wxDC *pdc, PI_S57Obj *pObj, PlugIn_ViewPort *vp, QRect rect, unsigned char *pixbuf );


int DECL_EXP PI_PLIBRenderAreaToGL( const QGLContext &glcc, PI_S57Obj *pObj,
                                    PlugIn_ViewPort *vp, QRect &render_rect );

int DECL_EXP PI_PLIBRenderObjectToGL( const QGLContext &glcc, PI_S57Obj *pObj,
                                    PlugIn_ViewPort *vp, QRect &render_rect );
...
extern DECL_EXP double fromDMM_Plugin( QString sdms );
extern DECL_EXP void SetCanvasRotation(double rotation);
extern DECL_EXP void SetCanvasProjection(int projection);
extern DECL_EXP bool GetSingleWaypoint( QString GUID, PlugIn_Waypoint *pwaypoint );
...
extern DECL_EXP QColor GetFontColour_PlugIn(QString TextElement);
 ...
 */
extern DECL_EXP bool PlugInPlaySoundEx( QString &sound_file, int deviceIndex=-1 );
extern DECL_EXP void AddChartDirectory( QString &path );
extern DECL_EXP void ForceChartDBUpdate();

extern  DECL_EXP QString GetWritableDocumentsDir( void );
extern  DECL_EXP QDialog *GetActiveOptionsDialog();
extern  DECL_EXP QStringList GetWaypointGUIDArray( void );
extern  DECL_EXP QStringList GetIconNameArray(void);

extern  DECL_EXP bool AddPersistentFontKey(QString TextElement);
extern  DECL_EXP QString GetActiveStyleName();

extern  DECL_EXP QBitmap GetBitmapFromSVGFile(QString filename, unsigned int width, unsigned int height);
extern  DECL_EXP bool IsTouchInterface_PlugIn(void);

/*  Platform optimized File/Dir selector dialogs */
extern  DECL_EXP int PlatformDirSelectorDialog( QWindow *parent, QString *file_spec, QString Title, QString initDir);

extern  DECL_EXP int PlatformFileSelectorDialog( QWindow *parent, QString *file_spec, QString Title, QString initDir,
...
extern DECL_EXP _OCPN_DLStatus OCPN_downloadFile( const QString& url, const QString &outputFile,
                                       const QString &title, const QString &message,
                                       const QBitmap& bitmap,
                                       QWindow *parent, long style, int timeout_secs);


/*   Asynchronous (Background) download of a single file  */

extern DECL_EXP _OCPN_DLStatus OCPN_downloadFileBackground( const QString& url, const QString &outputFile,
...
extern DECL_EXP _OCPN_DLStatus OCPN_postDataHttp( const QString& url, const QString& parameters, QString& result, int timeout_secs );
 ...
 *     getDLEventCondition == OCPN_DL_EVENTYPE_END
 */



class DECL_EXP OCPN_downloadEvent: public QEvent
{
public:
    OCPN_downloadEvent();
    ~OCPN_downloadEvent();
...
#ifdef MAKING_PLUGIN
extern   DECL_IMP QEvent::Type QEVT_DOWNLOAD_EVENT;
#else
extern   DECL_EXP QEvent::Type QEVT_DOWNLOAD_EVENT;
#endif
...
extern DECL_EXP bool PlugInSetFontColor(const QString TextElement, const QColor color);
 ...
 */
extern DECL_EXP QString GetPluginDataDir(const char* plugin_name);

extern DECL_EXP bool ShuttingDown( void );

//  Support for MUI MultiCanvas model

extern DECL_EXP QWindow* PluginGetFocusCanvas();
extern DECL_EXP QWindow* PluginGetOverlayRenderCanvas();

extern "C"  DECL_EXP void CanvasJumpToPosition( QWindow *canvas, double lat, double lon, double scale);
extern "C"  DECL_EXP  int AddCanvasMenuItem(QAction *pitem, opencpn_plugin *pplugin, const char *name = "");
...
extern DECL_EXP QString GetSelectedWaypointGUID_Plugin( );
extern DECL_EXP QString GetSelectedRouteGUID_Plugin( );
extern DECL_EXP QString GetSelectedTrackGUID_Plugin( );

extern DECL_EXP std::unique_ptr<PlugIn_Waypoint> GetWaypoint_Plugin( const QString& ); // doublon with GetSingleWaypoint
extern DECL_EXP std::unique_ptr<PlugIn_Route> GetRoute_Plugin( const QString& );
extern DECL_EXP std::unique_ptr<PlugInrack> GetTrack_Plugin( const QString& );

extern DECL_EXP QWindow* GetCanvasUnderMouse( );
extern DECL_EXP int GetCanvasIndexUnderMouse( );
//extern DECL_EXP std::vector<QWindow *> GetCanvasArray();
extern DECL_EXP QWindow *GetCanvasByIndex( int canvasIndex );
...
extern DECL_EXP void SetMUICursor_PlugIn( QCursor *pCursor, int canvasIndex );
