...
public:
    ...
    QString GetPort(){ return m_portstring; }
 ...
 //    be safely called or polled, e.g. wxThread->Destroy();
    ...
    bool SentencePassesFilter(const QString& sentence, FilterDirection direction);
...
//extern const wxEventType EVTHREADMSG;
...
class GARMIN_Serialhread;
class GARMIN_USBhread;
...
public:
    ...
    int                     mhread_run_flag;
    GARMIN_Serialhread    *m_garmin_serial_thread;
    GARMIN_USBhread       *m_garmin_usb_thread;
...
//
//-------------------------------------------------------------------------------------------------------------
class GARMIN_Serialhread: public wxThread
{

public:

    GARMIN_Serialhread(GarminProtocolHandler *parent,
                         DataStream *GParentStream,
                         wxEvtHandler *MessageTarget,
                         QString port);
    ~GARMIN_Serialhread(void);
    void *Entry();
...
//
//-------------------------------------------------------------------------------------------------------------
class GARMIN_USBhread: public wxThread
{

public:

    GARMIN_USBhread(GarminProtocolHandler *parent,
                      DataStream *GParentStream,
                      wxEvtHandler *MessageTarget,
                      unsigned int device_handle,
                      size_t max_tx_size);
    ~GARMIN_USBhread(void);
    void *Entry();
