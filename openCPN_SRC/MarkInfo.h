...
public:
    ...
    OCPNIconCombo(wxWindow* parent, wxWindowID id, const QString& value = (""),
                  const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
                  int n = 0, const QString choices[] = NULL,
                  long style = 0, const wxValidator& validator = wxDefaultValidator, const QString& name = ("OCPNIconCombo") );
    ...
    int Append(const QString& item, wxBitmap bmp);
    void Clear( void );
...
public:
      LatLonTextCtrl(wxWindow* parent, wxWindowID id, const QString& value = (""),
            const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
            long style = 0, const wxValidator& validator = wxDefaultValidator,
            const QString& name = wxTextCtrlNameStr);
...
class MarkInfoDlg : public wxFrame
{
	...
	private:
        ...
        QString        m_Name_save;
        QString        m_IconName_save;
        int             m_current_icon_Index;
        double          m_lat_save;
        double          m_lon_save;
        QString        m_Description_save;
    ...
    public:
        MarkInfoDlg( wxWindow* parent, wxWindowID id = wxID_ANY, const QString& title = _("Waypoint Properties"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1, -1 ), long style = wxDEFAULT_FRAME_STYLE|wxFRAME_FLOAT_ON_PARENT|wxMAXIMIZE_BOX|wxRESIZE_BORDER );
        ~MarkInfoDlg();
        void Create();
        ...
        void UpdateHtmlList();
        void SetDialogTitle(const QString & title) { SetTitle(title); }
