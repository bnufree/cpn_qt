...
{
public:
      CDI(wxWindow* parent, wxWindowID id, long style, const QString& name);
...
{
public:
      AnnunText(wxWindow *parent, wxWindowID id, const QString& LegendElement, const QString& ValueElement);

      ~AnnunText();

      void SetALabel(const QString &l);
      void SetAValue(const QString &v);
      void OnPaint(wxPaintEvent& event);
      void RefreshFonts(void);
      void SetLegendElement(const QString &element);
      void SetValueElement(const QString &element);
      void SetColorScheme(ColorScheme cs);
      void MouseEvent( wxMouseEvent& event );
...
private:
      ...
      QString    m_LegendTextElement;
      QString    m_ValueTextElement;
