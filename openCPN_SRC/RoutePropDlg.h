...
class RoutePropDlg : public wxFrame
{
	...
	public:
		...
		RoutePropDlg( wxWindow* parent, wxWindowID id = wxID_ANY, const QString& title = _("Route Properties"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 550,450 ), long style = wxDEFAULT_FRAME_STYLE|wxFRAME_FLOAT_ON_PARENT|wxTABRAVERSAL );
