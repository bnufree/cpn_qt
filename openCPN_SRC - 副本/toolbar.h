...
public:
    ...
    ToolbarItemContainer( int toolid, wxBitmap bmpNormal, wxBitmap bmpDisabled,
                            wxItemKind kind, QString tooltip, QString label)
    {   m_ID = toolid;
        m_tipString = tooltip;
        m_label = label;
        m_toolKind = kind;
...
public:
      GrabberWin( wxWindow *parent,  ocpnFloatingToolbarDialog *toolbar, float scale_factor,
                  QString icon_name, wxPoint position = wxDefaultPosition );
...
public:
      ...
      ocpnToolBarSimple( wxWindow *parent, wxWindowID winid, const wxPoint& pos = wxDefaultPosition,
                  ...
                  const QString& name = wxToolBarNameStr ) : m_one_shot(500)  {
            Init();
      ...
      bool Create( wxWindow *parent, wxWindowID winid, const wxPoint& pos = wxDefaultPosition,
                  const wxSize& size = wxDefaultSize, long style = wxNO_BORDER | wxTB_HORIZONTAL,
                  const QString& name = wxToolBarNameStr );
      ...
      wxToolBarToolBase *AddTool( int toolid, const QString& label, const wxBitmap& bitmap,
                  const wxBitmap& bmpDisabled, wxItemKind kind = wxITEM_NORMAL,
                  const QString& shortHelp = wxEmptyString, const QString& longHelp =
                              wxEmptyString, wxObject *data = NULL );

      wxToolBarToolBase *AddTool( int toolid, const QString& label, const wxBitmap& bitmap,
                  const QString& shortHelp = wxEmptyString, wxItemKind kind = wxITEM_NORMAL ) {
            return AddTool( toolid, label, bitmap, wxNullBitmap, kind, shortHelp );
      }

      wxToolBarToolBase *InsertTool( size_t pos, int id, const QString& label,
                  const wxBitmap& bitmap, const wxBitmap& bmpDisabled, wxItemKind kind,
                  const QString& shortHelp, const QString& longHelp, wxObject *clientData );
      ...
      void SetToolNormalBitmapEx(wxToolBarToolBase *tool, const QString & iconname);
      void SetToolNormalBitmapSVG(wxToolBarToolBase *tool, QString fileSVG);
      ...
      virtual void SetToolBitmapsSVG( int id, QString fileSVGNormal,
                                      QString fileSVGRollover,
                                      QString fileSVGToggled );
      ...
      virtual void SetToolShortHelp( int toolid, const QString& helpString );
      virtual QString GetToolShortHelp( int toolid ) const;
      virtual void SetToolLongHelp( int toolid, const QString& helpString );
      virtual QString GetToolLongHelp( int toolid ) const;
...
protected:
      ...
      virtual wxToolBarToolBase *DoAddTool( int toolid, const QString& label,
                  const wxBitmap& bitmap, const wxBitmap& bmpDisabled, wxItemKind kind,
                  const QString& shortHelp = wxEmptyString, const QString& longHelp =
      ...
      virtual wxToolBarToolBase *CreateTool( int winid, const QString& label,
                  const wxBitmap& bmpNormal, const wxBitmap& bmpDisabled, wxItemKind kind,
                  wxObject *clientData, const QString& shortHelp, const QString& longHelp );
...
public:
      ...
      void SetGrabber( QString icon_name );
      ...
      void SetToolConfigString(QString string){ m_configString = string; }
      QString GetToolConfigString(){ return m_configString; }
      ...
      void SetToolShortHelp( int toolid, const QString& helpString );
      ...
      size_t GetToolCount();
      void SetToolShowMask( QString mask );
      QString GetToolShowMask( void ){ return m_toolShowMask; }
      ...
      QString m_tblastAISiconName;
      wxToolBarToolBase *m_pTBAISTool;
      bool m_toolbar_scale_tools_shown;
      void SetBackGroundColorString( QString colorRef );
...
private:
      ...
      QString m_backcolorString;
      int m_cornerRadius;
      QString m_toolShowMask;
